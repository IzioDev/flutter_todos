...
/// [TodoReorderableListState.startItemDragReorder]. This is most easily achieved
...
/// [TodoReorderableListState.startItemDragReorder] method.
///
/// This widget's [TodoReorderableListState] can be used to manually start an item
/// reorder, or cancel a current drag. To refer to the
/// [TodoReorderableListState] either provide a [GlobalKey] or use the static
...
class TodoReorderableList extends StatefulWidget {
  ...
  static TodoReorderableListState of(BuildContext context) {
    assert(context != null);
    final TodoReorderableListState? result =
        context.findAncestorStateOfType<TodoReorderableListState>();
    assert(() {
      if (result == null) {
        throw FlutterError.fromParts(<DiagnosticsNode>[
          ...
          ErrorHint(
            ...
            'of how to refer to an TodoReorderableListState object:\n'
            '  https://api.flutter.dev/flutter/widgets/TodoReorderableListState-class.html',
          ),
  ...
  ///    is found.
  static TodoReorderableListState? maybeOf(BuildContext context) {
    assert(context != null);
    return context.findAncestorStateOfType<TodoReorderableListState>();
  }

  @override
  TodoReorderableListState createState() => TodoReorderableListState();
}
...
///
/// ```dart
/// GlobalKey<TodoReorderableListState> listKey = GlobalKey<TodoReorderableListState>();
/// ...
/// ReorderableList(key: listKey, ...);
/// ...
/// listKey.currentState.cancelReorder();
/// ```
class TodoReorderableListState extends State<TodoReorderableList> {
  final GlobalKey<SliverTodoReorderableListState> _sliverReorderableListKey =
      GlobalKey();
...
/// [SliverTodoReorderableListState.startItemDragReorder]. This is most easily
...
/// item drag method.
///
/// This widget's [SliverTodoReorderableListState] can be used to manually start an item
/// reorder, or cancel a current drag that's already underway. To refer to the
/// [SliverTodoReorderableListState] either provide a [GlobalKey] or use the static
...
class SliverReorderableList extends StatefulWidget {
  ...
  @override
  SliverTodoReorderableListState createState() =>
      SliverTodoReorderableListState();
  ...
  static SliverTodoReorderableListState of(BuildContext context) {
    assert(context != null);
    final SliverTodoReorderableListState? result =
        context.findAncestorStateOfType<SliverTodoReorderableListState>();
    assert(() {
      if (result == null) {
        throw FlutterError.fromParts(<DiagnosticsNode>[
          ErrorSummary(
          ...
          ErrorHint(
            ...
            '  https://api.flutter.dev/flutter/widgets/SliverTodoReorderableListState-class.html',
          ),
          context.describeElement('The context used was'),
        ]);
      }
  ...
  ///    ancestor is found.
  static SliverTodoReorderableListState? maybeOf(BuildContext context) {
    assert(context != null);
    return context.findAncestorStateOfType<SliverTodoReorderableListState>();
  }
}
...
///
/// ```dart
/// GlobalKey<SliverTodoReorderableListState> listKey = GlobalKey<SliverTodoReorderableListState>();
/// ...
...
class SliverTodoReorderableListState extends State<SliverReorderableList>
...
class _ReorderableItemState extends State<_ReorderableItem> {
  late SliverTodoReorderableListState _listState;
...
class ReorderableDragStartListener extends StatelessWidget {
  ...
  void _startDragging(BuildContext context, PointerDownEvent event) {
    final SliverTodoReorderableListState? list =
...
class _DragInfo extends Drag {
  ...
  late SliverTodoReorderableListState listState;
  late int index;
  late Widget child;
...
class _DragItemProxy extends StatelessWidget {
  ...
  final SliverTodoReorderableListState listState;
  final int index;
  final Widget child;
...
class _ReorderableItemGlobalKey extends GlobalObjectKey {
  ...
  final Key subKey;
  final int index;
  final SliverTodoReorderableListState state;
